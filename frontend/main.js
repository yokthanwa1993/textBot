...
const GRAPHQL_URL = process.env.NODE_ENV === 'production' 
  ? 'https://textbot-api.your-domain.com/graphql'  // แก้ไข domain ของคุณ
  : 'https://api.wwoom.com/graphql';

// Configuration
const CONFIG = {
  FETCH_TIMEOUT: 3000,
  LIFF_ID: '2007783990-0Y48Q7rB'
};
...
async function saveMessage() {
  ...
  try {
    ...
    const userId = currentUserId || "Ud6f275bfc4e5f8a113c10e05a2df80f8";
